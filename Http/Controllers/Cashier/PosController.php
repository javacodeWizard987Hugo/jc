...
class PosController extends Controller
{
    ...
    public function createSale(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'split_payments.*.method' => 'nullable|in:cash,cheque,credit,card',
            'split_payments.*.amount' => 'nullable|numeric|min:0',
            'split_payments.*.cheque_number' => 'nullable|string',
            'split_payments.*.bank_name' => 'nullable|string',
            'split_payments.*.cheque_date' => 'nullable|date',
            'discount_approval_reason' => 'nullable|string',
            'down_payment_amount' => 'nullable|numeric|min:0',
            'number_of_installments' => 'nullable|integer|min:1',
            'monthly_installment_amount' => 'nullable|numeric|min:0',
