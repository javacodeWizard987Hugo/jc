...
<body class="bg-gradient-to-br from-red-50 to-white min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-xl border-2 border-red-200">
        ...
        <?php if($errors->has('csrf_token')): ?>
            <div class="mb-4 bg-red-500 border-l-4 border-red-700 text-white px-4 py-3 rounded-lg shadow-lg" role="alert">
                <div class="flex items-center">
                    <span class="text-lg mr-2">❌</span>
                    <span class="text-sm font-semibold"><?php echo e($errors->first('csrf_token')); ?></span>
                </div>
            </div>
        <?php endif; ?>
        
        <form class="mt-8 space-y-6" method="POST" action="<?php echo e(route('login')); ?>" id="loginForm">
            <?php echo csrf_field(); ?>
            
            <div class="mb-4 text-center">
                <button type="button" id="toggleLoginMode" class="text-sm text-red-600 hover:text-red-700 underline">
                    Switch to <?php echo e(old('login_mode') === 'pin' ? 'Email/Password' : 'PIN'); ?> Login
                </button>
            </div>
            
            <div class="space-y-4" id="emailPasswordLogin" style="display: <?php echo e(old('login_mode') === 'pin' ? 'none' : 'block'); ?>;">
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                    <input id="email" name="email" type="email" 
                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['email'];
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password" name="password" type="password" 
                               class="mt-1 block w-full px-3 py-2 pr-10 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="space-y-4" id="pinLogin" style="display: <?php echo e(old('login_mode') === 'pin' ? 'block' : 'none'); ?>;">
                <div>
                    ...
                    <input id="pin" name="pin" type="text" maxlength="6" pattern="[0-9]{6}" 
                           class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500 <?php $__errorArgs = ['pin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                           value="<?php echo e(old('pin')); ?>" autofocus placeholder="000000">
                    <?php $__errorArgs = ['pin'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
            ...
            <input type="hidden" name="login_mode" id="login_mode" value="<?php echo e(old('login_mode', 'email')); ?>">
            
            <div class="flex items-center" id="rememberDiv" style="display: <?php echo e(old('login_mode') === 'pin' ? 'none' : 'flex'); ?>;">
...
<?php /**PATH F:\jc_enterprice\resources\views/auth/login.blade.php ENDPATH**/ ?>