...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'POS System - GC SOLUTION'); ?></title>
    ...
    <script>
        ...
        let inactivityTimer;
        const sessionTimeout = <?php echo e($sessionTimeout ?? 120); ?> * 60 * 1000; // Convert to milliseconds
        ...
        document.querySelectorAll('a[href*="password.change"]').forEach(function(link) {
            link.addEventListener('click', function(e) {
                ...
                if (!this.href || this.href === '#') {
                    e.preventDefault();
                    window.location.href = '<?php echo e(route("password.change")); ?>';
                }
            });
        });
    </script>
...
<body class="bg-gray-50">
    <div class="letterhead" style="display: none;">
        <h1><?php echo e(config('app.name', 'POS System')); ?></h1>
        ...
        <aside id="sidebar" class="sidebar">
            ...
            <nav class="sidebar-scroll p-4">
                <?php if(auth()->user()->isAdmin()): ?>
                    ...
                    <a href="<?php echo e(route('admin.pos')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.pos') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">💰</span>
                    ...
                    <a href="<?php echo e(route('admin.grns.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.grns.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📋</span>
                        <span class="nav-item-text">GRN</span>
                    </a>
                    <!--<a href="<?php echo e(route('admin.stock-adjustments.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.stock-adjustments.*') ? 'active' : ''); ?>">
                    ...
                    <a href="<?php echo e(route('admin.suppliers.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.suppliers.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">🏢</span>
                        <span class="nav-item-text">Suppliers</span>
                    </a>
                    <a href="<?php echo e(route('admin.customer-history.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.customer-history.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📜</span>
                        <span class="nav-item-text">Customer History</span>
                    </a>
                   <!-- <a href="<?php echo e(route('admin.stock-transfers.index')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.stock-transfers.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">🔄</span>
                    ...
                    <a href="<?php echo e(route('admin.credits.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.credits.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">💳</span>
                        <span class="nav-item-text">Credits</span>
                    </a>
                    <a href="<?php echo e(route('admin.installments.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.installments.index') || request()->routeIs('admin.installments.show') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">🗓️</span>
                        <span class="nav-item-text">All Installments</span>
                    </a>
                     <a href="<?php echo e(route('cashier.installments.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.installments.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">🗓️</span>
                            <span class="nav-item-text">Installment History</span>
                        </a>
                    <a href="<?php echo e(route('admin.installments.overdue')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.installments.overdue') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">⚠️</span>
                        <span class="nav-item-text">Overdue Installments</span>
                    </a>
                    <a href="<?php echo e(route('admin.installments.sms-reminder')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.installments.sms-reminder') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📱</span>
                    ...
                    <a href="<?php echo e(route('admin.expense-categories.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.expense-categories.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📂</span>
                    ...
                    <a href="<?php echo e(route('admin.reports.sales')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.sales') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📈</span>
                        <span class="nav-item-text">Sales Report</span>
                    </a>
                  <!--  <a href="<?php echo e(route('admin.warranties.index')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.warranties.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">📄</span>
                            <span class="nav-item-text">Warranties</span>
                        </a>

                        <a href="<?php echo e(route('admin.warranty-jobs.index')); ?>"
                        class="nav-item <?php echo e(request()->routeIs('admin.warranty-jobs.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">🛠</span>
                            <span class="nav-item-text">Warranty Jobs</span>-->
                        </a>
                    <a href="<?php echo e(route('admin.reports.stock')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.stock') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📦</span>
                        <span class="nav-item-text">Stock Report</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.profit-loss')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.profit-loss') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">💵</span>
                        <span class="nav-item-text">Profit & Loss</span>
                    </a>
                     <a href="<?php echo e(route('admin.reports.paid-off-agreements')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.paid-off-agreements') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">✅</span>
                        <span class="nav-item-text">Paid Off Agreements</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.installment-income')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.installment-income') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📈</span>
                        <span class="nav-item-text">Installment Income</span>
                    </a>
                   <!--  <a href="<?php echo e(route('admin.reports.delay-payments')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.delay-payments') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">⏰</span>
                        <span class="nav-item-text">Delay Payments Report</span>
                    </a>-->
                    <a href="<?php echo e(route('admin.reports.daily-installments')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.daily-installments') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">🗓️</span>
                        <span class="nav-item-text">Daily Installment Details</span>
                    </a>
                     <a href="<?php echo e(route('admin.reports.cash-collection')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.cash-collection') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">💰</span>
                        <span class="nav-item-text">Cash Collection Report</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.online-collection')); ?>" 
                        class="nav-item <?php echo e(request()->routeIs('online-collection') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">💻</span>
                            <span class="nav-item-text">Online Collection</span>
                        </a>
  <!--<a href="<?php echo e(route('admin.reports.on-date-installments')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.on-date-installments') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📅</span>
                        <span class="nav-item-text">On Date Installments</span>
                    </a>-->
                  
   <a href="<?php echo e(route('admin.estimate-report')); ?>" 
   class="nav-item <?php echo e(request()->routeIs('admin.estimate-report') ? 'active' : ''); ?>">
    <span class="nav-item-icon">📊</span>
    <span class="nav-item-text">Estimate Report</span>
</a>  

<a href="<?php echo e(route('admin.reports.estimate-collection')); ?>" 
   class="nav-item <?php echo e(request()->routeIs('admin.reports.estimate-collection') ? 'active' : ''); ?>">
    <span class="nav-item-icon">📊</span>
    <span class="nav-item-text">Estimate Collection</span>
</a>


<a href="<?php echo e(route('admin.reports.outstanding-installments')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.outstanding-installments') ? 'active' : ''); ?>">
    
                        <span class="nav-item-icon">❗</span>
                        <span class="nav-item-text">Outstanding Installments</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.disconnect')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.disconnect') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">🚫</span>
                        <span class="nav-item-text">Disconnect Report</span>
                    </a>
                    <!--<a href="<?php echo e(route('admin.reports.customer-behavior')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.customer-behavior') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">👤</span>
                        <span class="nav-item-text">Customer Behavior</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.sales-growth')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.sales-growth') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📊</span>
                        <span class="nav-item-text">Sales Growth</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.sales-tracking')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.sales-tracking') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📍</span>
                        <span class="nav-item-text">Sales Tracking</span>
                    </a>-->
                    <a href="<?php echo e(route('admin.reports.daily-installment-income')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.daily-installment-income') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">💰</span>
                        <span class="nav-item-text">Daily Installment Income</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.supplier-ledger')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.supplier-ledger') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📋</span>
                        <span class="nav-item-text">Supplier Ledger</span>
                    </a>
                    <a href="<?php echo e(route('admin.reports.expenses')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.reports.expenses') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">💰</span>
                  ...
                  <!--  <a href="<?php echo e(route('admin.sale-approvals.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.sale-approvals.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">✅</span>
                        <span class="nav-item-text">Approvals</span>
                    </a>
                    <a href="<?php echo e(route('admin.shift.summary')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.shift.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📊</span>
                    ...
                    <a href="<?php echo e(route('admin.system-settings.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.system-settings.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">🛠️</span>
                        <span class="nav-item-text">System Settings</span>
                    </a>
                    <a href="<?php echo e(route('admin.audit-logs.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.audit-logs.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📝</span>
                        <span class="nav-item-text">Logs</span>
                    </a>
                   <!-- <a href="<?php echo e(route('admin.sms-campaigns.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.sms-campaigns.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">📱</span>
                        <span class="nav-item-text">SMS Campaigns</span>
                    </a>-->
                    <a href="<?php echo e(route('admin.sms-templates.index')); ?>" class="nav-item <?php echo e(request()->routeIs('admin.sms-templates.*') ? 'active' : ''); ?>">
                        <span class="nav-item-icon">✉️</span>
                        <span class="nav-item-text">SMS Templates</span>
                    </a>
                <?php else: ?>
                    <?php if(auth()->user()->hasPermission('dashboard')): ?>
                        <a href="<?php echo e(route('cashier.dashboard')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.dashboard') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">🏠</span>
                            <span class="nav-item-text">Dashboard</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->user()->hasPermission('billing')): ?>
                        ...
                        <a href="<?php echo e(route('cashier.pos')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.pos') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">💰</span>
                            <span class="nav-item-text">POS</span>
                        </a>
                        <a href="<?php echo e(route('cashier.items.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.items.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">📦</span>
                            <span class="nav-item-text">Items</span>
                        </a>
                        <a href="<?php echo e(route('cashier.grns.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.grns.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">📥</span>
                            <span class="nav-item-text">GRN</span>
                        </a>
                    <?php endif; ?>

                    <?php if(auth()->user()->hasPermission('customers')): ?>
                        <div class="text-red-200 text-xs font-semibold px-4 py-2 mt-4 mb-2 uppercase tracking-wider">People</div>
                        <a href="<?php echo e(route('cashier.customers.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.customers.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">👥</span>
                            <span class="nav-item-text">Customers</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->user()->hasPermission('payments')): ?>
                        <div class="text-red-200 text-xs font-semibold px-4 py-2 mt-4 mb-2 uppercase tracking-wider">Financial</div>
                        <a href="<?php echo e(route('cashier.credits.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.credits.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">💳</span>
                            <span class="nav-item-text">Credits</span>
                        </a>
                        <a href="<?php echo e(route('cashier.expenses.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.expenses.*') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">💰</span>
                            <span class="nav-item-text">Expenses</span>
                        </a>
                    <?php endif; ?>
                    ...
                    <?php if(auth()->user()->hasPermission('reports')): ?>
                        <div class="text-red-200 text-xs font-semibold px-4 py-2 mt-4 mb-2 uppercase tracking-wider">Reports</div>
                        <a href="<?php echo e(route('cashier.reports.stock')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.reports.stock') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">📦</span>
                            <span class="nav-item-text">Stock Report</span>
                        </a>
                        <a href="<?php echo e(route('cashier.reports.supplier-ledger')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.reports.supplier-ledger') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">📋</span>
                            <span class="nav-item-text">Supplier Ledger</span>
                        </a>
                        <a href="<?php echo e(route('cashier.reports.expenses')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.reports.expenses') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">💰</span>
                            <span class="nav-item-text">Expenses Report</span>
                        </a>
                        <a href="<?php echo e(route('cashier.warranty.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.warranty.*') ? 'active' : ''); ?>">
    <span class="nav-item-icon">🛡️</span>
    <span class="nav-item-text">Warranty Management</span>
</a>
                    <?php endif; ?>

                    <?php if(auth()->user()->hasPermission('audit_logs')): ?>
                        <div class="text-red-200 text-xs font-semibold px-4 py-2 mt-4 mb-2 uppercase tracking-wider">Management</div>
                        <a href="<?php echo e(route('cashier.audit-logs.index')); ?>" class="nav-item <?php echo e(request()->routeIs('cashier.audit-logs.index') ? 'active' : ''); ?>">
                            <span class="nav-item-icon">📝</span>
                            <span class="nav-item-text">Logs</span>
                        </a>
                    <?php endif; ?>
            ...
            <div >
                ...
                <a href="<?php echo e(route('password.change')); ?>" class="nav-item mb-2">
                    <span class="nav-item-icon">🔒</span>
            ...
            <main class="p-6">
                <?php if(session('success')): ?>
                    <div class="mb-6 bg-green-500 border-l-4 border-green-700 text-black px-6 py-4 rounded-lg shadow-lg flex items-center" role="alert">
                        ...
                        <span class="text-lg font-semibold"><?php echo e(session('success')); ?></span>
                    </div>
                <?php endif; ?>

                <?php if(session('session_expired')): ?>
                    ...
                    <div class="mb-6 bg-red-500 border-l-4 border-red-700 text-white px-6 py-4 rounded-lg shadow-lg" role="alert">
                        ...
                        <ul class="list-disc list-inside ml-6">
                            <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="text-base"><?php echo e($error); ?></li>
...
<?php /**PATH F:\jc_enterprice\resources\views/layouts/app.blade.php ENDPATH**/ ?>