...
console.log('Route prefix from server:', '<?php echo e($routePrefix); ?>');
</script>

<!-- Hidden data for JavaScript -->
<div id="app-data" data-route-prefix="<?php echo e($routePrefix); ?>"></div>
...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="mb-6 flex justify-between items-center bg-white p-4 rounded-lg shadow-md">
        ...
        <div class="text-base font-semibold text-gray-700 bg-gray-100 px-4 py-2 rounded-lg">
            <?php echo e(ucfirst(auth()->user()->role)); ?>: <span class="text-red-600"><?php echo e(auth()->user()->name); ?></span>
        </div>
    </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-2 border-gray-200">
                ...
                <div id="itemsGrid" class="grid grid-cols-2 md:grid-cols-3 gap-4 max-h-96 overflow-y-auto">
                    <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        ?>
                        <button onclick="handleItemClick(event, <?php echo e($item->id); ?>, '<?php echo e($item->name); ?>', <?php echo e($item->selling_price); ?>, <?php echo e($item->current_stock); ?>, '<?php echo e($item->unit_of_measure); ?>')" 
                        ...
                        <div class="font-bold text-base text-gray-900 mb-1"><?php echo e($item->name); ?></div>
                        <div class="text-sm text-gray-600 mb-2"><?php echo e($item->item_code); ?></div>
                        <div class="text-sm text-gray-700 mb-1">1 PCS: Rs. <?php echo e(number_format($item->selling_price, 2)); ?></div>
                        <div class="text-lg font-bold text-red-600 mb-2">Rs. <?php echo e(number_format($item->selling_price, 2)); ?></div>
                        <div class="text-sm font-semibold text-gray-700 bg-gray-100 px-2 py-1 rounded">
                            Stock: <?php echo e(App\Models\Item::formatStock($item->current_stock, $item->unit_of_measure)); ?>
                    ...
                    <div class="bg-blue-50 p-5 rounded-xl border-2 border-blue-200">
                            ...
                            <div class="flex flex-wrap justify-between items-center gap-3 mb-3">
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <a href="<?php echo e(route('admin.customer-history.index')); ?>"
...
<form id="saleForm" method="POST" action="<?php echo e($salesCreateRoute); ?>" style="display: none;">
    <?php echo csrf_field(); ?>
...
const maxDiscount = <?php echo e($maxDiscount); ?>;
const taxRate = <?php echo e($taxRate); ?>;
const roundingRules = '<?php echo e($roundingRules ?? "none"); ?>';
...
function holdBill() {
    ...
    const csrfToken = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || '<?php echo e(csrf_token()); ?>';
    fetch('<?php echo e(route($routePrefix . ".bills.hold")); ?>', {
        method: 'POST',
        headers: {
...
document.getElementById('itemSearch').addEventListener('keydown', function(e) {
    ...
    if (e.key === 'Enter' && barcodeBuffer.length >= 8 && /^\d+$/.test(barcodeBuffer) && !isTyping) {
        ...
        fetch(`<?php echo e(route($routePrefix . '.items.search')); ?>?q=${encodedQuery}`, {
            headers: {
                'X-CSRF-TOKEN': csrfToken,
                'X-Requested-With': 'XMLHttpRequest',
                'Accept': 'application/json'
...
if (itemSearchInput) {
    itemSearchInput.addEventListener('input', function(e) {
        ...
        searchTimeout = setTimeout(() => {
            const csrfToken = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content') || '<?php echo e(csrf_token()); ?>';
            const searchUrl = `<?php echo e(route($routePrefix . '.items.search')); ?>?q=${encodeURIComponent(query)}`;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\jc_enterprice\resources\views/cashier/pos.blade.php ENDPATH**/ ?>