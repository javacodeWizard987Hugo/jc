...
<head>
    ...
    <title>Register - Chicken Shop POS</title>
...
<body class="bg-gradient-to-br from-red-50 to-white min-h-screen flex items-center justify-center">
    <div class="max-w-md w-full space-y-8 p-8 bg-white rounded-lg shadow-xl border-2 border-red-200">
        <div class="text-center">
            <h1 class="text-4xl font-bold text-red-600 mb-2">🍗</h1>
            <h2 class="text-3xl font-bold text-gray-900">Create New Account</h2>
            <p class="mt-2 text-sm text-gray-600">Sign up for Chicken Shop POS</p>
            <p class="mt-1 text-xs text-gray-500">New accounts are created as Cashier. Admin can change your role later.</p>
        </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" id="togglePasswordConfirmation" 
                            ...
                            <svg id="eyeSlashIconConfirmation" class="h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path>
                            </svg>
                        </button>
                    </div>
