...
<div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow rounded-lg p-6 mb-6">
        <form method="GET" action="{{ route('admin.credits.index') }}" class="grid grid-cols-4 gap-4">
            <div>
            ...
            <div class="col-span-4 flex justify-end">
                ...
                <a href="{{ route('admin.credits.index') }}" class="ml-2 bg-gray-200 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-300">
                    Clear
                </a>
            </div>
        </form>
            ...
            <tbody class="bg-white divide-y divide-gray-200" id="creditsTableBody">
                ...
                <tr data-credit-id="{{ $credit->id }}" 
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <a href="{{ route('admin.credits.show', $credit) }}" class="text-red-600 hover:text-red-900">View</a>
                    </td>
                </tr>
                @empty
                <tr>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function addCreditRow(credit) {
        ...
        row.innerHTML = `
            ...
            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                <a href="/admin/credits/${credit.id}" class="text-red-600 hover:text-red-900">View</a>
            </td>
        `;
