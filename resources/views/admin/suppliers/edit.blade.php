        ...
        <form action="{{ route($routePrefix . '.suppliers.update', $supplier) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="address" id="address" rows="2"
                          class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-red-500 focus:border-red-500">{{ old('address', $supplier->address) }}</textarea>
            </div>
