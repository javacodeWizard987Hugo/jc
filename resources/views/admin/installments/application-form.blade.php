...
<head>
    <meta charset="UTF-8">
    <title>Application Form - {{ $sale->invoice_number }}</title>
    <style>
        @page {
            size: A4;
            margin: 0;
...
<body>
    ...
    <div class="container">
        <div class="header">
            <img src="{{ asset('images/letter_head.png') }}" alt="Company Letterhead">
        </div>
    ...
    <span style="border-bottom: 1px solid #000; padding: 0 50px;">
        ...
        <div class="form-row">
            ...
            <div class="value-box">{{ $sale->customer->nic }}</div>
        </div>

        <div class="form-row">
            <div class="label">Full Name in NIC</div>
            <div class="value-box" style="height: 40px;">{{ $sale->customer->name }}</div>
        </div>

        <div class="form-row">
            <div class="label">Address</div>
            <div class="value-box" style="height: 30px;">{{ $sale->customer->address }}</div>
        </div>

        <div class="grid-2">
            <div class="form-row">
                <div class="label">Mobile No</div>
                <div class="value-box">{{ $sale->customer->phone }}</div>
            </div>
            <div class="form-row">
        ...
        <div class="form-row">
            ...
            <div class="value-box">{{ $installment->customer_institute_name_address }}</div>
        </div>

        <div class="form-row">
            <div class="label">Designation</div>
            <div class="value-box">{{ $installment->customer_occupation }}</div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="value-box">{{ $installment->combined_emi_numbers }}</div>
        </div>

        <div class="grid-2">
            <div class="form-row">
                <div class="label">Market Retail Price</div>
                <div class="value-box">{{ number_format($sale->subtotal, 2) }}</div>
            </div>
            <div></div>
        </div>
        ...
        <div class="grid-2">
            <div class="form-row">
                ...
                <div class="value-box">{{ number_format($installment->down_payment_amount, 2) }}</div>
            </div>
            <div></div>
        </div>
        ...
        <div class="grid-2">
            <div class="form-row">
                ...
                <div class="value-box">{{ number_format($installment->balance_amount, 2) }}</div>
            </div>
            <div></div>
        </div>
        ...
        <div class="grid-2">
            <div class="form-row">
                ...
                <div class="value-box">{{ number_format($installment->monthly_installment_amount, 2) }}</div>
            </div>
            <div class="form-row">
                <div class="label" style="width: 100px; padding-left: 10px;">Installment Date</div>
                <div class="value-box">{{ $installment->due_day_of_month }}</div>
            </div>
        </div>
        ...
        <div class="form-row">
            ...
            <div class="checkbox-group">
                <div class="checkbox-item">
                    <span class="square">{{ $installment->number_of_installments == 3 ? '✓' : '' }}</span> 03 Month
                </div>
                <div class="checkbox-item">
                    <span class="square">{{ $installment->number_of_installments == 6 ? '✓' : '' }}</span> 06 Month
                </div>
                <div class="checkbox-item">
                    <span class="square">{{ !in_array($installment->number_of_installments, [3,6]) ? '✓' : '' }}</span> Other ({{ $installment->number_of_installments }} Months)
                </div>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="label">NIC Number</div>
            <div class="value-box">{{ $installment->guarantor_nic }}</div>
        </div>

        <div class="form-row">
            <div class="label">Name with Initials</div>
            <div class="value-box">{{ $installment->guarantor_name }}</div>
        </div>

        <div class="form-row">
            <div class="label">Address</div>
            <div class="value-box" style="height: 30px;">{{ $installment->guarantor_address }}</div>
        </div>

        <div class="form-row">
            <div class="label">Mobile No</div>
            <div class="value-box">{{ $installment->guarantor_mobile_number }}</div>
        </div>
